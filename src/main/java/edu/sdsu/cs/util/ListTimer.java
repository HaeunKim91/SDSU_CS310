...
public final class ListTimer {
    ...
    private static <E1> List<String> timeRemoveMethods(List<E1> sut,
        ...
        test(new AddCommand<>(sut, values, false), endingSize, new
                RemoveMiddleCommand<>(sut), endingSize, null, output);
        // todo: MIDDLE STUDENT CODE SECTION
        ...
        test(new AddCommand<>(sut, values, false), endingSize, new
                RemoveEndCommand<>(sut), endingSize, null, output);
    ...
    private static class RemoveMiddleCommand<E1> extends ListCommand<E1> {
        RemoveMiddleCommand(List<E1> underTest) {
            super(underTest, null);
        }
    ...
    private static class RemoveEndCommand<E1> extends ListCommand<E1> {
        RemoveEndCommand(List<E1> underTest) {
            super(underTest, null);
        }
